...
demo = {
  ...
  initFullCalendar: function(eventos) {
  ...
  initDashboardPageCharts: function() {
    ...
    // Utiliza los datos pasados como argumento para inicializar la gráfica
    var data = {
     labels: ['JUL', 'AUG', 'SEP', 'OCT', 'NOV', 'DEC'],
     datasets: [{
       label: "Data",
  ...
  showSwal: function(type , ) {
    ...
    }else if (type == 'eliminar_razon_social') {
      swal({
        title: '¿Deseas eliminar la razón social?',
        text: 'You will not be able to recover this imaginary file!',
        type: 'warning',
        showCancelButton: true,
        confirmButtonText: 'Yes, delete it!',
