                      ...
                      <div class="card-body">
                        <form action="" method="post">
                          ...
                          <div class="form-group">
                            <input type="text" class="form-control" name="colaborador_id" value="{{ qcolab($vacacion->colaborador_id) }}">
                          </div>
                          <div class="form-group">
                            <label for="">Días de vacaciones</label>
                            <input type="text" name="dias" id="dias" value="{{ $diasDeVacaciones }}" readonly class="form-control">
                          </div>
                          <label>Fecha inicio</label>
                          <div class="form-group">
                            <input type="date" class="form-control" value="{{ $vacacion->desde }}" name="desde" id="desde" min="<?php echo date('Y-m-d', strtotime('+1 day')); ?>">
                          </div>
                          <label>Fecha fin</label>
                          <div class="form-group">
                            <input type="date" class="form-control" id="hasta" name="hasta" value="{{ $vacacion->hasta }}">
                          </div>
                          <label>Comentarios</label>
                          <div class="form-group">
                            <textarea name="comenatrios" class="form-control">{{ $vacacion->comentarios }}</textarea>
                          </div>
                          <div class="text-center">
                            <button type="button" class="btn btn-info" id="btnCrear" style="display:none;" name="button">Crear</button>
                          </div>
