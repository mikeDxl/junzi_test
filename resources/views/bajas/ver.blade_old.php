                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            @endphp
                              ...
                              @php
                                ...
                                $montoVacaciones = $datosbaja->vacaciones ?? ($csd * $dias_vacaciones);
                            ...
                            <tr>
                              ...
                              <td >$<span> {{ $vacaciones_pendientes*$sd }} </span></td>
                            </tr>
                            <tr>
                              <td>PRIMA VACACIONAL</td>
                              <?php $vac=$sd*$dias_vacaciones; ?>
                              <td>
                                <div class="input-group">
                            ...
                            <tr>
                                ...
                                <div class="input-group">
                                  @php
                                    ...
                                    if ($baja->motivo === 'Renuncia') {
                                        ...
                                        $montoIncentivo = $datosbaja->d_incentivo ?? '0';
                                    } else {
                              ...
                              @php
                                // Se vuelve a aplicar la lógica para mostrar el monto formateado
                                if ($baja->motivo === 'Renuncia') {
                                    // Si es renuncia, el incentivo es cero si no existe otro valor
                                    $montoIncentivo = $datosbaja->incentivo ?? 0;
                                } else {
                                    // Si no es renuncia, se hace el cálculo con el salario
                                    $montoIncentivo = $datosbaja->incentivo ?? ($sdi * $aldiadehoy) * 0.20;
                                }
                          ...
                          @php
                            ...
                            <tr>
                              ...
                              <td>$<span id="monto_gratificacion">{{ number_format($montoGratificacion, 2) }}</span></td>
                            </tr>
                            ...
                            @php
                                ...
                                if ($baja->motivo === 'Renuncia') {
                                    ...
                                    $montoVeinteDias = $datosbaja->d_veinte_dias ?? 0; // Por defecto en cero
                                } else {
                            ...
                            <tr>
                                ...
                                <td>$<span id="monto_veinte_dias">{{ number_format($datosbaja->veinte_dias ?? (calcularAniosDesdeDias($diastodos) * 20) * $sdi, 2) }}</span></td>
                            </tr>
                            ...
                            @php
                                // Verifica si el motivo es renuncia
                                if ($baja->motivo === 'Renuncia') {
                                    // Si es renuncia, el monto de despensa se establece en cero a menos que d_despensa tenga un valor
                                    $d_despensa = $datosbaja->d_despensa ?? 0; // Por defecto en cero
                                    $montoDespensa = 0; // Monto en cero por defecto
                                } else {
                                    // Si no es renuncia, se calcula el monto normalmente
                                    $d_despensa = $datosbaja->d_despensa ?? '15'; // Valor por defecto
                                    $montoDespensa = $datosbaja->despensa ?? ($sdi * $aldiadehoy * 0.15);
                                }
                            @endphp
