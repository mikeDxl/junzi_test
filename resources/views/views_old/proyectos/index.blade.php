@extends('layouts.app', ['activePage' => 'Proyectos', 'menuParent' => 'laravel', 'titlePage' => __('Proyectos')])
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">Proyectos <small>({{ count($proyectos) }})</small> </h4>
              </div>
              <div class="card-body">

                <div class="row">
                  <div class="col-12 text-right mb-3">
                    <form class="" action="/proyectos/nuevo" method="get">
                      @csrf
                          ...
                          <td>
                            ...
                            <td class="td-actions text-right">
                              <form action= method="post">
                                  <a href="/proyecto/{{ $proy->id }}" class="btn btn-link btn-warning btn-icon btn-sm edit"><i class="tim-icons icon-pencil"></i></a>
                                  <button type="button" class="btn btn-link btn-danger btn-icon btn-sm remove" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick="eliminar('{{ $proy->proyecto }}' , '{{ $proy->id }}')">
