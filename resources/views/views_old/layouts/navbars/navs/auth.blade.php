...
border-radius: 50%; /* Para hacer el número redondo */
    ...
    <div class="collapse navbar-collapse" id="navigation">
      ...
      <form id="fijar_rs" action="{{ route('fijar_rs') }}" method="post">
        ...
        <select id="company_id" class="form-control" style="text-transform: capitzalize!important;" name="company_id">
          ...
          <option selected value="{{ session('company_active_id') }}" style="text-transform: capitzalize!important;">{{ session('company_active_name') }}</option>
          @else
...
<div class="modal modal-search fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="searchModal" aria-hidden="true" style="background:#f5f5f5!important;">
