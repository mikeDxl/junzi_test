      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <div class="form-group">
                <input class="form-control" name="fecha_inicio" value="{{ $colaborador->tipo_descuento }}"   type="date"  required />
          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <div class="form-group">
                <input class="form-control" name="fin_infonavit" value="{{ $colaborador->fin_infonavit }}"   type="date"  required />
              </div>
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <div class="form-group">
                 <input class="form-control"  type="text" value="{{ puestos2($colaborador->puesto) }}"/>
              </div>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-sm-9">
              <div class="form-group">
                <input type="text" class="form-control" name="" value="{{jefedirecto($colaborador->jefe_directo,$colaborador->company_id)}}">
              </div>
            </div>
          </div>
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <div class="form-group">
                <input class="form-control"   type="text"   value="{{ $colaborador->fonacot }}"/>
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <div class="form-group">
                <input class="form-control"   type="text"  value="{{ $colaborador->afore }}" />
              </div>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-9">
              <div class="form-group">
                <input class="form-control"   type="text"   value="{{ $colaborador->umf }}"/>
              </div>
            </div>
          </div>
