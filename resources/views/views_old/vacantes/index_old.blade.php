            ...
            <div class="col-md-12 mb-4">
                <div class="card text-start">
                  <div class="card-header text-end bg-transparent">
                      <a href="{{ route('alta-vacantes') }}"><button type="button" class="btn btn-primary btn-md m-1"><i class="i-Add-User text-white me-2"></i> Agregrar vacante</button></a>
                  </div>
                  <div class="card-body">
                              ...
                              <tbody>
                                  @foreach($vacantes as $vac)
                                      <tr>
                                          ...
                                          <td>{{ $vac->estatus  }}</td>
                                          <td>
                                              <a href="/editar-vacantes/{{ $vac->id }}" class="ul-link-action text-success" data-toggle="tooltip"
