                ...
                <div class="row justify-content-center">
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="centro_de_costos" id="centros">
                        <option value="">Selecciona una opción:</option>
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control"  required name="departamento" id="departamentos">
                          <option value="">Selecciona una opción:</option>
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="puesto" id="puestos">
                        <option value="">Selecciona una opción:</option>
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="jefe_directo" id="jefes_directos" >
                        <option value="">Selecciona</option>
                        @foreach($colaboradores as $colabs)
                        <option value="{{ $colabs->id }}">{{ qcolab($colabs->id) }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="registro_patronal_id" id="registros">
                        <option value="">Selecciona una opción</option>
...
<script>
  ...
  $(document).ready(function() {
      ...
      $('.choices').css('width', '90%');
  });
  </script>
  <script type="text/javascript">
  if (document.getElementById('puestos')) {
      var element = document.getElementById('puestos');
      const example = new Choices(element, {
        searchEnabled: true
      });
      };

  if (document.getElementById('departamentos')) {
      var element = document.getElementById('departamentos');
      const example = new Choices(element, {
        searchEnabled: true
      });
      };
  if (document.getElementById('jefes_directos')) {
      var element = document.getElementById('jefes_directos');
      const example = new Choices(element, {
        searchEnabled: true
      });
      };
  if (document.getElementById('centros')) {
      var element = document.getElementById('centros');
      const example = new Choices(element, {
        searchEnabled: true
      });
      };
...
if (document.getElementById('registros')) {
    var element = document.getElementById('registros');
    const example = new Choices(element, {
      searchEnabled: true
    });
    };
