        ...
        <form action="/colaboradores/alta" method="post" enctype="multipart/form-data">
                ...
                <div class="row justify-content-center mt-5">
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" name="razon_social" required>
                        <option value="{{ $company_id }}">{{ empresa($company_id) }}</option>
                        @foreach($razones as $rz)
                          @if($rz->id!=$company_id)
                          <option value="{{ $rz->id }}">{{ $rz->nombre }}</option>
                          @endif
                        @endforeach
                      </select>
                    </div>
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" required  name="nombre" class="form-control" placeholder="Nombre" value="{{ $datoscolab->nombre }}" style="text-transform:uppercase;">
                    </div>
                  </div>
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" required  name="apellido_paterno" class="form-control" value="{{ $datoscolab->apellido_paterno }}" placeholder="Apellido Paterno" style="text-transform:uppercase;">
                    </div>
                  </div>
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" required  name="apellido_materno" class="form-control" value="{{ $datoscolab->apellido_materno }}" placeholder="Apellido Materno" style="text-transform:uppercase;">
                    </div>
                  </div>
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select id="banco"  name="banco" class="form-control">
                          ...
                          <option value="{{ $banco->clave }}">{{ $banco->banco }}</option>
                          @endforeach
                        </select>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="tipodemetododepago">
                        ...
                        <option value="{{ $tp->nomipaq }}">{{ $tp->tipo}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                ...
                <div class="row justify-content-center">
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <input type="number" required readonly  name="numero_de_empleado" class="form-control" placeholder="Número de empleado" min="{{ $numero_de_empleado }}" pattern="[0-9]*" value="{{ $numero_de_empleado }}">
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <input type="date" name="fecha_ingreso" required class="form-control"  min="{{ date('Y-m-d') }}" placeholder="Fecha de ingreso" value="{{ $fecha_alta }}">
                    </div>
                  </div>
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="centro_de_costos" id="centro_de_costos" onchange="buscarDepartamentos();">
                        <option value="{{ $vacante_info->area_id }}">{{ $vacante_info->area }}</option>
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control"  required name="departamento" id="departamento" onchange="buscarPuestos()">
                        <option value="{{ catalogopuestodepaid($puesto) }}">{{ catalogopuestodepa($puesto) }}</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="puesto" id="puesto" onchange="buscarColaborador();">
                        <option value="{{ $puesto }}">{{ catalogopuesto($puesto) }}</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="jefe_directo" id="jefe_directo" >
                        <option value="{{ $vacante_info->jefe }}">{{ qcolab($vacante_info->jefe) }}</option>
                      </select>
                    </div>
                  </div>
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="registro_patronal_id">
                        <option value="">Selecciona una opción</option>
                  ...
                  <div class="col-sm-5">
                    ...
                    <div class="input-group">
                      ...
                      <select class="form-control" required name="tiposdecontrato">
                        ...
                        <option value="{{ $tc->nomipaq }}">{{ $tc->tipo}}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
          ...
          <div class="card-footer">
            <div class="pull-right">
              ...
              <input type="hidden" name="codigoorganigrama" value="{{ $codigoorganigrama ?? '' }}">
              <input type="hidden" name="candidato_id" value="{{ $candidato_id ?? '' }}">
              <input type="hidden" name="vacante_id" value="{{ $vacante_info->id ?? '' }}">
